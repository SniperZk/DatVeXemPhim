namespace DatVeXemPhim
{
    ...
    {
        public static readonly string CONNECTION_STRING = "Initial Catalog=CINEMA_PROJECT;Data Source=localhost\\SQLEXPRESS;TrustServerCertificate=True;Trusted_Connection=True";
